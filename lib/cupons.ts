...
export const AVAILABLE_COUPONS: Coupon[] = [
  ...
  { code: 'PROMO47', discountPercentage: 10, isActive: true, allowedProduct: 'TEMPLATE' },
  
  // Cupons exclusivos para Personalizados (Preço base 147)
  { code: 'VIP147', discountPercentage: 20, isActive: true, allowedProduct: 'PERSONALIZADO' },
  
  // Cupom que funciona em qualquer um
  { code: 'STUDIO10', discountPercentage: 10, isActive: true, allowedProduct: 'ALL' },
];
