...
export const AVAILABLE_COUPONS: Coupon[] = [
  ...
  { code: 'ESPECIAL10', discountPercentage: 10, isActive: true, allowedProduct: 'TEMPLATE' },
  
  // Cupons exclusivos para Personalizados (Preço base 147)
  { code: 'ESPECIAL10', discountPercentage: 10, isActive: true, allowedProduct: 'PERSONALIZADO' },
