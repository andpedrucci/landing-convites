...
function SucessoTemplatesContent() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-beige-50 via-white to-beige-100 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-beige-100 px-4 py-2 rounded-full mb-6">
            <Sparkles className="w-5 h-5 text-beige-300" />
            <span className="text-sm font-medium text-brown-700">Pedido de Templates Recebido</span>
          </div>

          <div className="bg-beige-50 rounded-2xl p-6 mb-8 text-left">
            ...
            <ol className="space-y-3 text-brown-600">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">Vamos personalizar seus 2 convites com as informações do evento</span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">Você receberá uma prévia para aprovação antes da entrega final</span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">Após aprovação, enviaremos os arquivos em alta resolução</span>
              </li>
            </ol>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a
              href="https://wa.me/5511995087592?text=Olá!%20Acabei%20de%20comprar%20os%20templates"
              target="_blank"
          ...
          <p className="text-xs text-brown-600/60 mt-8">
            💝 Obrigada por escolher a Studio Invitare!
          </p>
        </div>
...
export default function SucessoTemplates() {
  return (
    <Suspense fallback={
