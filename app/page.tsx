  ...
  return (
    <>
      <main className="snap-y snap-mandatory h-screen overflow-y-scroll scroll-smooth">
        ...
        <section id="hero" className="snap-section snap-start relative overflow-hidden min-h-screen flex items-center">
          ...
          <div className="relative max-w-7xl mx-auto px-6 py-20 w-full">
            <div className={`text-center transition-all duration-1000 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-8xl font-serif text-brown-700 mb-6 md:mb-8 leading-[1.1] px-4 mt-8 md:mt-16">
                Convites que tocam<br />
                <span className="text-beige-300 italic font-light">o coração</span>
              </h1>
              <p className="text-base sm:text-lg md:text-2xl text-brown-600 max-w-3xl mx-auto mb-8 md:mb-14 font-light leading-relaxed px-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-8 md:px-12 py-4 md:py-5 bg-beige-300 text-white rounded-full font-medium text-base md:text-lg hover:bg-beige-400 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-2xl group"
              >
                <span className="text-sm md:text-base">Encontrar meu convite perfeito</span>
                <Heart className="w-4 h-4 md:w-5 md:h-5 group-hover:fill-white transition-all" />
              </button>
            </div>
          </div>
        </section>
        ...
        <section id="carrossel" className="snap-section snap-start min-h-screen flex items-center px-6 relative bg-gradient-to-b from-beige-50 via-white to-beige-50">
          <div className="relative max-w-7xl mx-auto w-full py-20 overflow-visible">
            <div className="text-center mb-8">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-brown-700 mb-2">Explore nossos <span className="text-beige-300 italic">temas exclusivos</span></h2>
            ...
            <div className="relative h-[300px] md:h-[450px] flex items-center justify-center mb-8 overflow-visible">
              <div className="relative w-full h-full preserve-3d overflow-visible" style={{ perspective: '1200px' }}>
                {getImagensTema(temaAtivo).map((imagem, index) => {
                  ...
                  const radius = typeof window !== 'undefined' && window.innerWidth < 768 ? 250 : 450;
                  
                  return (
                    <div 
                      key={index} 
                      className="absolute left-1/2 top-1/2 w-48 h-64 md:w-72 md:h-96 cursor-pointer carousel-card transition-all duration-700"
                      style={{ 
                        transform: `translateX(-50%) translateY(-50%) rotateY(${angle}deg) translateZ(${diff === 0 ? radius + 30 : radius}px)`,
                    ...
                    >
                      ...
                      />
                      {diff === 0 && (
                        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-2 md:p-4 rounded-b-xl">
                          <p className="text-white font-medium text-center text-xs md:text-base">{imagem.nome}</p>
                        </div>
                      )}
                    </div>
                  );
        ...
        <section id="como-funciona" className="snap-section snap-start min-h-screen flex items-center px-6 relative bg-gradient-to-b from-beige-50 to-white">
          <div className="max-w-6xl mx-auto w-full py-12 md:py-20">
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-brown-700 mb-3">
                Como <span className="text-beige-300 italic">funciona?</span>
              </h2>
              <p className="text-sm md:text-base text-brown-600">Convites prontos! Simples, rápido e feito com carinho para você</p>
            </div>

            <div className="grid md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12">
              <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-beige-100 rounded-full mb-4 md:mb-6">
                  <svg className="w-8 h-8 md:w-10 md:h-10 text-beige-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                  </svg>
                </div>
                <h3 className="text-lg md:text-xl font-serif text-brown-700 mb-3">1. Escolha seu convite</h3>
              ...
              <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all text-center">
                ...
                <h3 className="text-lg md:text-xl font-serif text-brown-700 mb-3">2. Pagamento seguro</h3>
                <p className="text-brown-600 text-sm leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all text-center">
                ...
                <h3 className="text-lg md:text-xl font-serif text-brown-700 mb-3">3. Entrega do Convite</h3>
                <p className="text-brown-600 text-sm leading-relaxed">
            ...
            <div className="bg-gradient-to-r from-beige-100 to-rose-100 rounded-2xl p-6 md:p-8 text-center">
              <div className="flex items-center justify-center gap-2 mb-3">
                <Heart className="w-5 h-5 md:w-6 md:h-6 text-beige-300" />
                <h3 className="text-lg md:text-xl font-serif text-brown-700">Convite Personalizado</h3>
                <Heart className="w-5 h-5 md:w-6 md:h-6 text-beige-300" />
              </div>
              <p className="text-sm md:text-base text-brown-600 max-w-2xl mx-auto">
        ...
        {/* PRODUTOS */}
        <section id="produtos" className="snap-section snap-start py-8 md:py-12 px-4 md:px-6 min-h-screen flex items-center bg-gradient-to-b from-white to-beige-50">
          <div className="max-w-7xl mx-auto w-full">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-brown-700 mb-3">
                Escolha seu <span className="text-beige-300 italic">estilo perfeito</span>
              </h2>
              <p className="text-sm md:text-base text-brown-600">Convites prontos ou totalmente personalizados</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto">
              <div className="bg-white rounded-[2rem] p-6 md:p-8 shadow-2xl border border-beige-200/50 hover:shadow-3xl transition-all flex flex-col min-h-[520px] md:h-[580px]">
                <div className="text-center mb-4 md:mb-6">
                  <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-beige-100 rounded-full mb-3 md:mb-4">
                    <Sparkles className="w-8 h-8 md:w-10 md:h-10 text-beige-300" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-serif text-brown-700 mb-2">Convites Prontos</h3>
                  <p className="text-brown-600 text-xs md:text-sm">Escolha 2 convites do mesmo tema</p>
                </div>
                ...
                <ul className="space-y-2 md:space-y-3 mb-4 md:mb-6 flex-grow">
                  <li className="flex items-start gap-2 text-brown-600">
                    ...
                    <span className="text-xs md:text-sm">Preencha as informações do evento</span>
                  </li>
                  <li className="flex items-start gap-2 text-brown-600">
                    <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span className="text-xs md:text-sm">Nossa equipe faz uma revisão</span>
                  </li>
                  <li className="flex items-start gap-2 text-brown-600">
                    <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span className="text-xs md:text-sm">Pronto! te entregamos uma imagem de alta qualidade do convite e um arquivo configurado para impressão</span>
                  </li>
                </ul>
                ...
                <div className="mt-auto space-y-2 md:space-y-3">
                  <button 
                    ...
                    className="w-full py-3 md:py-3.5 bg-beige-300 text-white rounded-full font-medium text-sm md:text-base hover:bg-beige-400 transition-all"
                  >
                    Escolher Templates
                  </button>
                  <a 
                    href={getWhatsAppLink("Templates Digitais", "")} 
                    className="block text-center text-beige-300 border border-beige-300 py-2.5 md:py-3 rounded-full text-sm md:text-base hover:bg-beige-50 transition-all"
                  >
                    Tirar Dúvidas
                  </a>
                </div>
              ...
              <div className="bg-gradient-to-br from-beige-300 to-beige-400 rounded-[2rem] p-6 md:p-8 shadow-2xl text-white hover:shadow-3xl transition-all relative overflow-hidden flex flex-col min-h-[520px] md:h-[580px]">
                <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-sm px-2 md:px-3 py-1 rounded-full text-[10px] md:text-xs font-bold">
                  EXCLUSIVO
                </div>
                
                <div className="text-center mb-4 md:mb-6">
                  <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-white/20 backdrop-blur-sm rounded-full mb-3 md:mb-4">
                    <Heart className="w-8 h-8 md:w-10 md:h-10 text-white" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-serif mb-2">Convite Personalizado</h3>
                  <p className="text-white/90 text-xs md:text-sm">Criado especialmente para você</p>
                </div>
                
                <ul className="space-y-2 md:space-y-3 mb-4 md:mb-6 flex-grow">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-white flex-shrink-0 mt-0.5" />
                    <span className="text-xs md:text-sm">Design 100% exclusivo</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-white flex-shrink-0 mt-0.5" />
                    <span className="text-xs md:text-sm">Criado do zero para você</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-white flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-white flex-shrink-0 mt-0.5" />
                    <span className="text-xs md:text-sm">2 revisões incluídas</span>
                  </li>
                </ul>
                ...
                <div className="mt-auto space-y-2 md:space-y-3">
                  <button 
                    ...
                    className="w-full py-3 md:py-3.5 bg-white text-beige-300 rounded-full font-medium text-sm md:text-base hover:bg-white/90 transition-all"
                  >
                    Quero Meu Convite
                  </button>
                  <a 
                    href={getWhatsAppLink("Convite Personalizado", "")} 
                    className="block text-center border border-white py-2.5 md:py-3 rounded-full text-sm md:text-base hover:bg-white/10 transition-all"
                  >
                    Tirar Dúvidas
                  </a>
                </div>
              ...
              <div className="bg-gradient-to-br from-rose-200 to-beige-200 rounded-[2rem] p-6 md:p-8 shadow-2xl hover:shadow-3xl transition-all relative overflow-hidden flex flex-col min-h-[520px] md:h-[580px]">
                <div className="absolute top-4 right-4 bg-white/40 backdrop-blur-sm px-2 md:px-3 py-1 rounded-full text-[10px] md:text-xs font-bold text-brown-700">
                  NOVO
                </div>
                
                <div className="text-center mb-4 md:mb-6">
                  <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-white/40 backdrop-blur-sm rounded-full mb-3 md:mb-4">
                    <Star className="w-8 h-8 md:w-10 md:h-10 text-beige-400" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-serif text-brown-700 mb-2">Assinatura Mêsversário</h3>
                  <p className="text-brown-700 text-xs md:text-sm">12 artes personalizadas para o 1º ano</p>
                </div>
                ...
                <ul className="space-y-2 md:space-y-3 mb-4 md:mb-6 flex-grow">
                  <li className="flex items-start gap-2 text-brown-700">
                    ...
                    <span className="text-xs md:text-sm">12 artes exclusivas (1 por mês)</span>
                  </li>
                  <li className="flex items-start gap-2 text-brown-700">
                    <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span className="text-xs md:text-sm">Acompanhe o crescimento do bebê</span>
                  </li>
                  <li className="flex items-start gap-2 text-brown-700">
                    <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span className="text-xs md:text-sm">Perfeito para redes sociais</span>
                  </li>
                  <li className="flex items-start gap-2 text-brown-700">
                    <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span className="text-xs md:text-sm">Design consistente todo mês</span>
                  </li>
                </ul>
        ...
        {/* FAQ */}
        <section id="faq" className="snap-section snap-start min-h-screen flex items-center px-4 md:px-6 py-12 md:py-20 bg-gradient-to-b from-beige-50 to-white">
          <div className="max-w-4xl mx-auto w-full">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-brown-700 mb-3">
                Perguntas <span className="text-beige-300 italic">Frequentes</span>
              </h2>
              <p className="text-sm md:text-base text-brown-600">Tire suas dúvidas sobre nossos convites</p>
            </div>

            <div className="space-y-3 md:space-y-4">
              <details className="bg-white rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all group">
                <summary className="flex items-center justify-between cursor-pointer font-semibold text-brown-700 text-base md:text-lg">
                  <span className="pr-4">Como funciona a entrega dos convites prontos?</span>
                  <span className="text-beige-300 text-xl md:text-2xl group-open:rotate-45 transition-transform flex-shrink-0">+</span>
                </summary>
                <p className="mt-3 md:mt-4 text-brown-600 text-sm md:text-base leading-relaxed">
              ...
              <details className="bg-white rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all group">
                <summary className="flex items-center justify-between cursor-pointer font-semibold text-brown-700 text-base md:text-lg">
                  <span className="pr-4">Posso editar os convites depois de receber?</span>
                  <span className="text-beige-300 text-xl md:text-2xl group-open:rotate-45 transition-transform flex-shrink-0">+</span>
                </summary>
                <p className="mt-3 md:mt-4 text-brown-600 text-sm md:text-base leading-relaxed">
              ...
              <details className="bg-white rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all group">
                <summary className="flex items-center justify-between cursor-pointer font-semibold text-brown-700 text-base md:text-lg">
                  <span className="pr-4">Qual a diferença entre &quot;Convites Prontos&quot; e &quot;Personalizado&quot;?</span>
                  <span className="text-beige-300 text-xl md:text-2xl group-open:rotate-45 transition-transform flex-shrink-0">+</span>
                </summary>
                <p className="mt-3 md:mt-4 text-brown-600 text-sm md:text-base leading-relaxed">
              ...
              <details className="bg-white rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all group">
                <summary className="flex items-center justify-between cursor-pointer font-semibold text-brown-700 text-base md:text-lg">
                  <span className="pr-4">Como funciona a Assinatura Mêsversário?</span>
                  <span className="text-beige-300 text-xl md:text-2xl group-open:rotate-45 transition-transform flex-shrink-0">+</span>
                </summary>
                <p className="mt-3 md:mt-4 text-brown-600 text-sm md:text-base leading-relaxed">
              ...
              <details className="bg-white rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all group">
                <summary className="flex items-center justify-between cursor-pointer font-semibold text-brown-700 text-base md:text-lg">
                  <span className="pr-4">Posso imprimir os convites?</span>
                  <span className="text-beige-300 text-xl md:text-2xl group-open:rotate-45 transition-transform flex-shrink-0">+</span>
                </summary>
                <p className="mt-3 md:mt-4 text-brown-600 text-sm md:text-base leading-relaxed">
              ...
              <details className="bg-white rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all group">
                <summary className="flex items-center justify-between cursor-pointer font-semibold text-brown-700 text-base md:text-lg">
                  <span className="pr-4">Quais formas de pagamento vocês aceitam?</span>
                  <span className="text-beige-300 text-xl md:text-2xl group-open:rotate-45 transition-transform flex-shrink-0">+</span>
                </summary>
        ...
        <section className="snap-section snap-start min-h-screen flex flex-col bg-gradient-to-b from-white to-beige-50">
          <div className="flex-grow flex items-center px-4 md:px-6 py-8 md:py-12">
            <div className="max-w-4xl mx-auto w-full text-center">
              <div className="bg-gradient-to-r from-beige-100 to-rose-100 rounded-3xl p-6 md:p-12 shadow-2xl">
                <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-white/60 backdrop-blur-sm rounded-full mb-4 md:mb-6">
                  <Send className="w-8 h-8 md:w-10 md:h-10 text-beige-300" />
                </div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-brown-700 mb-3 md:mb-4">
                  Ainda tem dúvidas?
                </h2>
                <p className="text-brown-600 text-sm md:text-lg mb-6 md:mb-8 max-w-2xl mx-auto">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-2 md:gap-3 px-6 md:px-10 py-3.5 md:py-5 bg-green-500 text-white rounded-full font-semibold text-base md:text-lg hover:bg-green-600 transition-all shadow-xl hover:scale-105"
                >
                ...
                <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-brown-700/10">
          ...
          <footer className="bg-brown-700 text-white rounded-t-3xl w-full">
            <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-10">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-5 md:mb-6">
                <div className="col-span-2 md:col-span-1">
                  <h3 className="text-base md:text-lg font-serif mb-2 md:mb-3">Studio Invitare</h3>
                  <p className="text-white/80 text-[11px] md:text-xs leading-relaxed mb-2 md:mb-3">
                    Criamos convites digitais com carinho e dedicação para tornar seu momento ainda mais especial.
                  </p>
                  <div className="flex gap-2">
                    <a href="https://instagram.com/studioinvitare" target="_blank" rel="noopener noreferrer" className="w-7 h-7 md:w-8 md:h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-all">
                    ...
                    <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="w-7 h-7 md:w-8 md:h-8 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-all">
                      <svg className="w-3.5 h-3.5 md:w-4 md:h-4" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                      </svg>
                    </a>
                ...
                <div>
                  <h3 className="text-xs md:text-sm font-semibold mb-2 md:mb-3">Links Rápidos</h3>
                  <ul className="space-y-1 md:space-y-1.5 text-[11px] md:text-xs">
                ...
                <div>
                  <h3 className="text-xs md:text-sm font-semibold mb-2 md:mb-3">Nossos Produtos</h3>
                  <ul className="space-y-1 md:space-y-1.5 text-[11px] md:text-xs">
                ...
                <div>
                  <h3 className="text-xs md:text-sm font-semibold mb-2 md:mb-3">Contato</h3>
                  <ul className="space-y-1 md:space-y-1.5 text-[11px] md:text-xs">
              ...
              <div className="border-t border-white/10 pt-4 md:pt-5 mb-4 md:mb-5">
                <div className="grid grid-cols-2 md:flex md:flex-wrap items-center justify-center gap-3 md:gap-6 text-white/60 text-[9px] md:text-[10px]">
              ...
              <div className="border-t border-white/10 pt-4 md:pt-5 text-center text-[11px] md:text-xs">
                <p className="text-white/60">© 2024 Studio Invitare - Todos os direitos reservados</p>
                <p className="text-white/40 mt-1 text-[9px] md:text-[10px]">Desenvolvido com 💕 para criar momentos inesquecíveis</p>
              </div>
            </div>
            ...
            {isPlaying && (
              <button 
                ...
                className="fixed bottom-20 md:bottom-24 right-4 md:right-8 bg-white/80 p-2 md:p-3 rounded-full shadow-lg text-brown-600 text-[9px] md:text-[10px] font-bold hover:bg-white transition-all z-40"
              >
                SOM ON/OFF
              </button>
            )}
            ...
            <a
              ...
              className="fixed bottom-4 md:bottom-8 right-4 md:right-8 bg-green-500 text-white p-3 md:p-4 rounded-full shadow-2xl hover:bg-green-600 transition-all hover:scale-110 z-50 flex items-center justify-center"
            >
