    ...
    <main className="min-h-screen bg-gradient-to-b from-beige-50 via-beige-100 to-beige-50">
      ...
      <section className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 w-full">
          ...
          {/* Showcase dos convites - Grid assimétrico */}
          <div className={`mt-24 max-w-5xl mx-auto transition-all duration-1000 delay-300 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
            <div className="grid md:grid-cols-5 gap-6">
              {/* Convite 1 - Maior */}
              <div className="md:col-span-3 bg-white rounded-3xl p-3 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.02] group">
                <div className="relative overflow-hidden rounded-2xl aspect-[3/4] bg-gradient-to-br from-beige-100 to-rose-100">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center p-8">
                      <p className="text-beige-300 text-6xl mb-4">🤱</p>
                      <p className="text-brown-600 font-serif text-2xl mb-2">Chá Revelação</p>
                      <p className="text-brown-600/60 text-sm">Menina ou Menino?</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Convite 2 - Menor */}
              <div className="md:col-span-2 bg-white rounded-3xl p-3 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.02] group">
                <div className="relative overflow-hidden rounded-2xl aspect-[3/4] bg-gradient-to-br from-rose-100 to-beige-100">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center p-6">
                      <p className="text-beige-300 text-5xl mb-3">🎂</p>
                      <p className="text-brown-600 font-serif text-xl mb-2">1 Aninho</p>
                      <p className="text-brown-600/60 text-xs">Celebração</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="bg-white rounded-[2rem] p-10 shadow-2xl hover:shadow-3xl transition-all duration-500 relative overflow-hidden group border border-beige-200/50">
              ...
              <div className="relative">
                ...
                {/* CTA */}
                <a
                  href={getWhatsAppLink("Template Pronto", "R$ 47")}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 w-full py-4 bg-beige-100 text-brown-700 text-center rounded-full font-medium hover:bg-beige-300 hover:text-white transition-all duration-300 shadow-md hover:shadow-xl group/btn"
                >
