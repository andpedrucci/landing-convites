...
const imagensPorTema = {
  ...
  'batizado': [
    { nome: 'Ripado', descricao: 'Charme e elegância', imagem: '/templates/batizado/INV-BAT-01.png' },
    { nome: 'Ripado', descricao: 'Charme e elegância', imagem: '/templates/batizado/INV-BAT-02.png' },
    { nome: 'Ripado', descricao: 'Charme e elegância', imagem: '/templates/batizado/INV-BAT-03.png' },
    { nome: 'Ripado', descricao: 'Charme e elegância', imagem: '/templates/batizado/INV-BAT-04.png' },
    { nome: 'Ripado', descricao: 'Charme e elegância', imagem: '/templates/batizado/INV-BAT-05.png' },
    { nome: 'Ripado', descricao: 'Charme e elegância', imagem: '/templates/batizado/INV-BAT-06.png' },
    { nome: 'Ripado', descricao: 'Charme e elegância', imagem: '/templates/batizado/INV-BAT-07.png' },
    { nome: 'Ripado', descricao: 'Charme e elegância', imagem: '/templates/batizado/INV-BAT-08.png' },
    { nome: 'Ripado', descricao: 'Charme e elegância', imagem: '/templates/batizado/INV-BAT-09.png' },
    { nome: 'Ripado', descricao: 'Charme e elegância', imagem: '/templates/batizado/INV-BAT-10.png' },
  ],
  'cha-bebe': [
